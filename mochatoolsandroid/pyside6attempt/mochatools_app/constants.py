...
# Android CPUs throttle under sustained load — use fewer parallel chunks on mobile
import sys as _sys
_on_android = hasattr(_sys, 'getandroidapilevel')
DEFAULT_MAX_CHUNKS = 6 if _on_android else 20   # 1–20 parallel chunks in flight at once
del _on_android, _sys
...
# Auto-updater URL (unused on Android, kept for source compatibility)
